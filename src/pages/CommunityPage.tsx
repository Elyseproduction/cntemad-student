...
export function CommunityPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col animate-fade-in h-full px-2 pt-4" style={{ overflow: 'hidden', position: 'relative' }}>
      ...
      {/* Messages */}
      <div ref={scrollRef} className="flex-1 space-y-3 pr-2" style={{ overflowY: 'auto', overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch' }}>
        {messages.length === 0 && (
