...
Tu dois retourner un JSON avec cette structure EXACTE :
{
  ...
  "resume_intro": "Résumé introductif du chapitre (2-3 phrases)",
  "sections": [
    {
  ...
  "schemas_detectes": [
    {
      ...
      "representation_texte": "Représentation en texte ASCII"
    }
  ],
...
- Utilise "code" pour les exemples de code, algorithmes, commandes
- Utilise "tableau" pour les données tabulaires ou comparaisons
- Utilise "schema" pour les diagrammes ou représentations visuelles en ASCII
